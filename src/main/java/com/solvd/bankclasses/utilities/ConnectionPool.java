...
import com.solvd.bankclasses.exeptions.NotConnectedExeption;
...
public class ConnectionPool {
    ...
    public synchronized Connection getConnection() {
        try {
            ...
            try {
                connectionPool.add(DriverManager.getConnection("jdbc:mysql://localhost:3306/mydb", "testuser", "1234"));
